...
@section('breadcrumb', __('Brands') . ' → ' . __('Create'))
...
<div class="page-header">
    <div class="page-title-wrap">
        <div class="page-title">{{ __('Create Brand') }}</div>
        <div class="gold-rule"></div>
        <div class="page-sub">{{ __('Add a new brand to your catalog') }}</div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="field">
                        ...
                        <input id="name_ar" type="text" name="name[ar]" value="{{ old('name.ar') }}"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="upload-area" id="uploadArea">
                        ...
                        <div class="upload-title">{{ __('Click or drag logo here') }}</div>
