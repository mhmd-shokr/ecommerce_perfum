...
@section('content')
    ...
    @php
        ...
        $shipping = $subtotal > 0 ? 10.00 : 0.00;   // flat rate — adjust as needed
                        ...
                        <div class="cart-item">
                            ...
                            <div class="item-product">
                                <div class="item-img">
                                    @if(!empty($item['images']))
                                        <img src="{{ asset('storage/' . $item['images']) }}" alt="{{ $item['name'] }}" loading="lazy">
                                    @else
                                        🧴
                                    @endif
                                </div>
                            ...
                            <div class="item-qty">
                                <div class="qty-form">
                                    ...
                                    <form method="POST" action="{{ route("cart.update", $productId) }}">
                                        ...
                                        <button type="submit" class="qty-btn" aria-label="{{ __('Decrease quantity') }}">−</button>
                                    </form>
                                    ...
                                    <form method="POST" action="{{ route("cart.update", $productId) }}">
                                        ...
                                        <button type="submit" class="qty-btn" aria-label="{{ __('Increase quantity') }}">+</button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="item-subtotal">
                                ...
                                <form method="POST" action="{{ route("cart.remove", $productId) }}">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="remove-btn" aria-label="{{ __('Remove item') }}"
                                        title="{{ __('Remove') }}">
            ...
            <div class="order-summary">
                ...
                <div class="summary-body">
                    ...
                    <div class="coupon-row">
                        <input type="text" class="coupon-input" placeholder="{{ __('Coupon code') }}">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var flash = document.querySelector('.cart-flash');
            if (flash) {
                setTimeout(function () {
