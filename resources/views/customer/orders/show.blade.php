    ...
    <div class="order-wrap">
        ...
        @if($order->payment_status === 'paid')
            <div class="invoice-btn-wrap">
                <a href="{{ route('my.order.invoice', $order->id) }}" class="invoice-btn">
                    {{ __('Download Invoice') }}
                </a>
            </div>
        @endif
                ...
                @foreach($order->items as $item)
                    <div class="o-item">
                        @if($item->product?->images)
                            <img src="{{ asset('storage/' . $item->product->images) }}" alt="{{ $item->product_name }}"
                                class="o-item-img" style="display:block;">
                        @else
